...
const Footer = () => {
  ...
  // ==========================================
  // OPEN GMAIL COMPLAINT
  // ==========================================
  const openGmail = () => {
    const subject = encodeURIComponent(
      "Complaint / Problem Report – TransNova Solutions"
    );
      ...
      <footer className="bg-[#0f0f0f] text-white font-manrope relative">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#9B9B8A] text-[10px]">
                    Global Clients
                  </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-8">
                ...
                >
                  ...
                  <div className="flex flex-col leading-none">
                    ...
                    <div className="flex items-baseline">
                      ...
                      <span className="ml-2 text-[14px] font-bold tracking-[-0.5px] text-[#FF6B35]">
                        NOVA
                      </span>

                      <span className="ml-2 text-[14px] font-bold tracking-[-0.5px] text-white">
                        SOLUTIONS
                      </span>
              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-1.5 text-[#9B9B8A] text-[12px]">
                  ...
                  {ourServices.slice(0, 4).map((link) => (
                    <li key={link.name}>
              ...
              <div className="col-span-2 md:col-span-1 space-y-2">
                ...
                <div className="mt-3">
                  ...
                  <button
                    type="button"
                    onClick={openGmail}
                    className="flex items-center gap-2 text-[#9B9B8A] hover:text-[#FF6B35] transition-colors group"
        ...
        <div className="border-t border-[#2a2a2a] py-4 px-6 lg:px-12 relative">
          ...
          <p className="text-center text-[#9B9B8A] text-[10px]">
            &copy; {new Date().getFullYear()} TransNova Solutions LLC.
            All Rights Reserved.
          </p>
